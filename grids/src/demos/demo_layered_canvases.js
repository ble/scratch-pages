...
draggy.addItem("foreground2", "Foreground 2");
draggy.addItem("foreground1", "Foreground 1");
draggy.addItem("background", "Background");
draggy.addEventListener("swapped", (evt) => {
    canvases.bringToFront(...draggy.order);
});
